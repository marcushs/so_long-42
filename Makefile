...
#    Updated: 2023/01/17 09:04:49 by hleung           ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
SRCS			=	get_next_line.c get_next_line_utils.c so_long.c map.c map_error.c backtrack.c backtrack_utils.c render.c hooks.c
OBJS			=	${SRCS:.c=.o}
HEADERS			=	includes
